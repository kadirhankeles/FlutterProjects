...
import 'package:spotify/karsilama.dart';
import 'package:spotify/library.dart';
import 'package:spotify/listenScreen.dart';
import 'package:spotify/loading.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(type: BottomNavigationBarType.fixed,backgroundColor: Colors.black ,items: [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.search_outlined, color: Colors.green ,),label: ''),
